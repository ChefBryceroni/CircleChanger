...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.original = self.circle.fill_color
        self.colors = colors
        self.colorindex = 0
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        for k in range(0, times_to_swell_or_shrink):
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        length = self.circle.center.x + other_circle_changer.circle.center.x
        height = self.circle.center.y + other_circle_changer.circle.center.y
        center = rg.Point(length / 2, height / 2)
        radius = (self.get_distance_from(other_circle_changer.circle.center)) / 2
        fill_color = 'red'
        colors = self.colors + other_circle_changer.colors
        new_circle = CircleChanger(center.x, center.y, radius, fill_color, colors)
        return new_circle
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.original
    ...
    def change_to_next_color_in_tuple(self):
        ...
        self.circle.fill_color = self.colors[self.colorindex]
        self.colorindex = self.colorindex + 1
        if self.colorindex == len(self.colors):
            self.colorindex = 0
        # for k in range(1, len(self.colors)):
